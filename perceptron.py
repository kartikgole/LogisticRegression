...
def loadtraindata(mean_1, mean_2, cov_1, cov_2):
    traindata_1 = np.append(np.random.multivariate_normal(mean_1, cov_1, 1000), np.zeros((1000, 1)), axis=1)
    traindata_2 = np.append(np.random.multivariate_normal(mean_2, cov_2, 1000), np.ones((1000, 1)), axis=1)
